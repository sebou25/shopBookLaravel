<header>
    ...
    <div class="navbar navbar-dark bg-dark fixed-top box-shadow">
        <div class="container d-flex justify-content-between">
            ...
            {{--<div class="panierNav2">--}}
            {{--<a class="nav-link text-white" href="{{route('cart_index')}}"><i class="fa fa-shopping-cart text-white"></i> Panier <span class="badge  text-white">{{$total}}</span></a></div>--}}
    ...
    {{--<nav class="navbar navbar-expand-lg navbar-light fixed-top bg-red nav2">--}}
        ...
        {{--<div class="collapse navbar-collapse justify-content-center" id="navbarNav">--}}
            ...
            {{--</ul>--}}
            {{--<ul class="navbar-nav ">--}}
                {{--<li class="nav-item espacepanier">--}}
                    {{--<a class="nav-link" href="{{route('cart_index')}}"><i class="fa fa-shopping-cart"></i> Panier <span class="badge badge-warning text-white">{{$total}}</span></a>--}}
                {{--</li>--}}
            {{--</ul>--}}
