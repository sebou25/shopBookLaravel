    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom topContenaireCommande">
                <h4 class="h2">Modifier un Tag</h4>
            ...
            @endif
                ...
                <form id="form-modif-prod" action="{{route('mettre_a_jour_tag',['id'=>$tag->id])}}" method="post">
                    @csrf
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label for="nom">Nom du tag</label>
                            <input type="text" class="form-control" value="{{$tag->nom}}" id="nom" name="nom">
                        </div>
                    </div>

                    <div class="form-row">
                        <div class="form-group">
                            <button type="submit" class="btn btn-info" form="form-modif-prod">Valider Actualiser</button>
                        </div>
                    </div>
                </form>
        </main>
