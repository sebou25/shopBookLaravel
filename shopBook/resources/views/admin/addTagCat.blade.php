    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom topContenaireCommande">
                <h4 class="h2"> Gestion des Tags</h4>

                <div class="btn-toolbar mb-2 mb-md-0 pull-right">

                    <button class="btn btn-sm btn-outline newProdAdmin"><a class="nav-link" href="{{route('admin_view_add_tags')}} " >Nouveau Tag </a></button>
                ...
                <table class="table table-sm table-striped">
                    ...
                    @foreach($tags as $tag)
                        <tr>
                            ...
                            <td>{{$tag->nom}}</td>
                            <td>
                                <a href="{{route('update_tag',['id'=>$tag->id])}}"  class="btn btn-sm btn-outline-info">Voir / Modifier</a>

                                <a onclick="return confirm('Êtes-vous sûr de vouloir supprimer {{$tag->nom}} ')" href="{{route('delete_tag',['id'=>$tag->id])}}" class="btn btn-sm btn-outline-danger">Supprimer</a></td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
