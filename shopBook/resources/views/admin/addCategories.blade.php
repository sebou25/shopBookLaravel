    ...
    <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom topContenaireCommande">
                <h4 class="h2">Ajouter une Catégorie</h4>
            ...
            @endif
            <form id="form-add-cat" action="{{route('admin_add_new_cat')}}" method="post">
                @csrf
                <div class="form-row">
            ...
            <input type="radio" id="customRadioInline1" name="is_online" class="custom-control-input" value="0 {{old('is_online')}}">
                    <label class="custom-control-label" for="customRadioInline1">0 / Masquer</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" id="customRadioInline2" name="is_online" class="custom-control-input"  value="1 {{old('is_online')}}">
                    <label class="custom-control-label" for="customRadioInline2">1 / Afficher</label>
                </div>
                <br><br>
                <button type="submit" class="btn btn-dark" form="form-add-cat">Valider</button>
            </form>
        </main>
    </div>
</div>
